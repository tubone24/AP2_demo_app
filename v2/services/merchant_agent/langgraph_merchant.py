            ...
            try:
                ...
                if signed_cart_mandate:
                    ...
                    while elapsed_time < MAX_CART_APPROVAL_WAIT_TIME:
                        ...
                        try:
                            poll_response = await self.http_client.post(
                                f"{self.merchant_url}/poll/cart",
                    ...
                    if elapsed_time >= MAX_CART_APPROVAL_WAIT_TIME:
                        ...
                        if langfuse_span:
                            langfuse_span.update(
                                ...
                                metadata={"elapsed_time": elapsed_time, "reason": "Manual approval timeout", "max_wait_time": max_wait_time}
                            )
                            langfuse_span.end()
                        return (None, status_dict)
