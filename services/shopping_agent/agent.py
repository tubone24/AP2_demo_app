...
from common.logger import get_logger, LoggingAsyncClient

# OpenTelemetry 手動トレーシング
from common.telemetry import get_tracer, create_http_span
...
class ShoppingAgent(BaseAgent):
    ...
    def register_endpoints(self):
        ...
        async def get_did_document():
            ...
            - did:ap2:agent:shopping_agent → http://shopping_agent:8000/.well-known/did.json
            """
            import json
            from pathlib import Path
            ...
            did_doc_file = did_docs_dir / "shopping_agent_did.json"
